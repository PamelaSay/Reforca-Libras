    ...
    return `
        <div style="display:grid;gap:12px;text-align:left;">
            ...
            <iframe
                ...
                title="Tradução do alerta da trilha de Radiciação em Libras"
...
function concluirEtapaRadiciacao(numero) {
...
// ==========================================
// RELATÓRIO GERAL DA Radiciação
// ==========================================

const NOMES_DAS_ETAPAS = {
    1: "Introdução à radiciação",
    2: "Elementos da radiciação",
    3: "Raízes exatas",
    4: "Propriedades"
};
...
function atualizarRelatorioRadiciacao() {
    const progresso =
        obterProgressoCurso();
